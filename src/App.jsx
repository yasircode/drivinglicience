...
import myProfilePhoto from './assets/pic.jpeg'; // Ensure this path is correct
...
const LicensePortal = () => {
  ...
  const handleVerify = () => {
    ...
    setUserData({
      ...
      licenceNo: "SL-22-22541",
      dob: "10-DEC-1999",
      CNIC: "34601-1651215-3",
      height: "5' 5\"",
      address: "Post Office Khas, Mandranwala Teshil Daska, District Sailkot",
      issueDate: "12-7-2022",
